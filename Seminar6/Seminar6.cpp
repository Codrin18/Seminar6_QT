...
Seminar6::Seminar6(Controller& ctrl, QWidget *parent) : ctrl(ctrl), QWidget(parent)
{
	this->initGUI();
...
void Seminar6::populateRepoList()
{
...
int Seminar6::getRepoListSelectedIndex()
{
	if (this->repoList->count() == 0)
		return -1;
...
void Seminar6::connectSignalsAndSlots()
{
